...
const getRTCookieName = (cookieNamePrefix: string): string => cookieNamePrefix + '-rt'
...
export {getTempLoginDataCookieName, getATCookieName, getRTCookieName, getIDCookieName}
